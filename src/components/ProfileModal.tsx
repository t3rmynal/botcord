...
export function ProfileModal({
  ...
  const noInputs = !globalName.trim() && !nick.trim() && !avatarPath && !resetAvatar
              ...
              <div className="grid grid-cols-[1fr_auto] gap-2 items-end">
                ...
                <div className="flex gap-1">
                  ...
                  <button
                    ...
                    className={
                      'h-9 px-3 border text-[11px] uppercase tracking-[0.22em] transition ' +
                      (resetAvatar
                        ? 'border-ink text-ink bg-bg-3'
                        : 'border-line-2 hover:border-ink text-ink-3 hover:text-ink')
                    }
                  >
                    reset
                  </button>
                  {(avatarPath || resetAvatar) && (
                    <button
                      onClick={() => {
                        setAvatarPath(null)
                        setResetAvatar(false)
